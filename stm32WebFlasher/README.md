...
- **Pre-flash serial monitoring** — log device output to the log panel between opening the port and starting programming.
...
5. Optionally enable **"Monitor serial output before flashing"** to see device prints in the log while connected but before programming starts.
