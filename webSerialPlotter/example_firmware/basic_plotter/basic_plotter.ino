 ...
 * https://gitee.com/eegithub/web-serial-plotter-cn
 */
...
void loop() {
  ...
  float temperature =
      20.0 + 15.0 * sin(millis() / 5000.0) + random(-100, 100) / 100.0;
  float humidity =
      50.0 + 20.0 * cos(millis() / 3000.0) + random(-200, 200) / 100.0;
  float pressure =
      1013.25 + 10.0 * sin(millis() / 8000.0) + random(-50, 50) / 100.0;
  float light =
      500.0 + 300.0 * sin(millis() / 2000.0) + random(-1000, 1000) / 100.0;
